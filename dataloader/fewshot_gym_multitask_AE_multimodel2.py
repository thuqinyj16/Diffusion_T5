...
from .utils_multimodel2 import MyQADataset, MyQAPromptDataset, MyQAPromptDataset_AE, MyDataLoader
from .metrics import METRICS, evaluate

class NLPFewshotGymMultiTaskData_AE(object):

    def __init__(self, logger, args, data_path, tasks, intr_emb, data_split, data_type, is_training, is_test=False):
        self.data_path = data_path
        self.data_type = data_type
        self.data = []
        self.intr_emb = intr_emb
    ...
    def load_dataset(self, tokenizer, do_return=False):
        ...
        if self.args.do_prompt and not (self.args.do_AE or self.args.do_ensemble):
            ...
            self.dataset = MyQAPromptDataset_AE(input_ids, attention_mask,
                                            ...
                                            task2id=self.task2id,intr_emb=self.intr_emb)
        else:
